...
<body>
	<?php if(!isset($_REQUEST['newa'])) include("include_pages/case_report_inc_a_cic.php"); ?>
	<?php if(!isset($_REQUEST['newb'])) include("include_pages/case_report_inc_new_cic.php"); ?>
</body>
</html>
