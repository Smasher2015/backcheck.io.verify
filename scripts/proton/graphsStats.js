...
proton.graphsStats = {
	...
	drawCharts : function () {
		...
		/*if($('#hero-bar-long').length)

		proton.graphsStats.graph.Bar = Morris.Bar({

		    element: 'hero-bar-long',

		    data: [

		      {device: 'Completed', geekbench: 258},

		      {device: 'In Progress', geekbench: 323},

		      {device: 'Need Attention', geekbench: 222},

		      {device: 'Discrepancy', geekbench: 333}
