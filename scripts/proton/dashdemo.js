...
proton.dashdemo = {
	...
	build: function () {
		/*setTimeout(function() {
			proton.dashdemo.newMessage('<li class="list-group-item new-item generated-item"><i><img alt="Haroon Bashir" src="images/default.png"></i><div class="text-holder"><span class="title-text">Haroon Bashir</span><span class="description-text">Check: Education</span></div><span class="stat-value">1 week 2 days ago</span></li>');
		}, 3500);*/
