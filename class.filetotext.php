		...
		foreach($lines as $thisline)
		  {
		    ...
		    $outtext = filter_var($outtext, FILTER_SANITIZE_STRING,FILTER_FLAG_STRIP_HIGH);
			
			 $outtext = utf8_encode(addslashes($outtext));  
			
		 $outtext = preg_replace("/[^a-zA-Z0-9\s\,\.\-\n\r\t@\/\_\(\)]/","",$outtext);
		 			//var_dump($outtext); die;
...
//$a = new Filetotext('uploads/hzafar(CV) (1).docx');
//$a = new Filetotext('hzafar(CV) (1).pdf');

//$a->filePath='hzafar(CV) (1).pdf';
//$a->decodePDF();
//echo $a->read_docx();
//echo $a->read_doc();
//echo $a->output();
