...
if($access){
	...
	$comInf = $db->select("ver_data vd inner join company co on vd.com_id=co.id","co.location","vd.v_id=$case");
	$rsCom = mysql_fetch_assoc($comInf);
	$com_location = $rsCom['location'];
	if($ascase!=0){
