<?php $fileaths = 'https://backcheck.io/verify/';
 ?>
...
.user-pane .no-photo {
    ...
    height: 300px;
    display: block;
    background: rgba(72,87,119,0.1) url("<?=$fileaths?>img/logo3.png") no-repeat bottom center;
    border-radius: 2px;
    margin: 0 0 25px 0;
}
  	 ...
  	 <div class="page-header">
        <div class="page-header-content">
			...
			<div class="heading-btn-group">
				<a href="javascript:;" class="btn btn-link btn-float has-text sidebar-control sidebar-secondary-hide hidden-xs" onClick="window.print()" id="asdasdsad"><i class="icon-printer text-primary"></i><span>Print this page</span></a>
...
<!--[if lte IE 8]>
    	...
    	<div class="sec_header">
        	<div class="logo_main">
            	<img src="<?=$fileaths?>img/logo2_pdf.png" alt="logo">
            </div>
        </div>
...
-->          
  ...
  <header class="head_logo">
	  <div class="logo"><img src="<?=$fileaths?>img/logo3.png" alt="BackCheckGroup" width="74px"> 
