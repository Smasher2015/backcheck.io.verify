...
session_start();
	...
	$param = "id=$id&plogid=$pid&name=$name&ftr=mis$ePara&showhf=1";

	//$url  = "http://184.107.222.178/getPDF/?url=".SURL."$page?$param";
	$url  = "http://198.23.193.178/getPDF/?url=".SURL."$page?$param";
