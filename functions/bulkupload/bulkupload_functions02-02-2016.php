...
function clientBulkUploadAjax2(){
			...
			if($_REQUEST['ERR']==''){
				...
				while(isset($_REQUEST['first_name'.$nums])){
					...
					if($check==$eduCheckID){
					$colsAddata = " (as_id,d_type,d_mtitle,d_stitle,d_num) ";
					$valsAddata = " ($CID,'multy','University Name','$uni_name',1),($CID,'multy','Registration Number','$reg_num',2),($CID,'multy','Degree Title','$degree',3),($CID,'multy','Remarks','$remarks',4),($CID,'multy','Passing Year','$pass_year',5),($CID,'multy','Serial No','$serial_no',6)";
					//insertSet
					...
					if($check==$empCheckID){
					$colsAddata = " (as_id,d_type,d_mtitle,d_stitle,d_num) ";
					$valsAddata = " ($CID,'multy','Company Name','$company_name',1),($CID,'multy','Date of Joining','$date_of_join',2),($CID,'multy','Employement Status','$emp_status',3),($CID,'multy','Last Working Day','$last_work_day',4),($CID,'multy','Last Designation','$last_designation',5),($CID,'multy','Last Place of Posting','$last_place_posted',6)";	
