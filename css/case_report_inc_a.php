...
<div class="ipg">
 ...
 <div class="sec-main-header">
	...
	<div class="sec-pdf-left-sec">
    		...
    		<img src="img/logowithtextbackcheck.jpg" alt="Risk Discovered" />
...
<tr>
    ...
    <td class="font-bold"><p><?php echo $asData['as_vstatus'];?></p><p>PLEASE REFER TO ANNEXURES BELOW.</p></td>
...
<ul>
      ...
      <?php if($status_vSts == 'red'){?>
    		...
    		<li><img src="img/alert_icon.png" width="64" /></li><li class="Red"><h3>HIGH RISK</h3>

    	<?php }elseif($status_vSts == 'green'){?><li class="Green"><h3>NO RISK</h3>

		<?php }else {?><li class="Amber"><h3><?php echo $vSts; ?></h3><?php }?>
...
T: +65 31080343  |  F: +65 67228310<br />
            ...
            <a href="www.backcheckgroup.com">www.backcheckgroup.com</a>-->
				...
				<div class="cnt-bgc-txt-bt">MITIGATING RISKS IN 200+ COUNTRIES WORLDWIDE </div>
