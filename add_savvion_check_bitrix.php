...
<head> <meta charset="utf-8">
	...
	<link href="<?php echo SURL; ?>styles/bt_savvion_chcks.css" rel="stylesheet" type="text/css">
...
.savvion-eduction-box1, .savvion-eduction-box2, .savvion-eduction-box3,.savvion-employment-box1, .savvion-employment-box2, .savvion-employment-box3,.savvion-health-box1, .savvion-health-box2
{
	border-bottom: 1px solid #eee;
...
.savvion-eduction-box1 h5, .savvion-eduction-box2 h5, .savvion-eduction-box3 h5,.savvion-employment-box1 h5, .savvion-employment-box2 h5, .savvion-employment-box3 h5, .savvion-health-box1 h5, .savvion-health-box2 h5
{
    padding: 10px 8px;
    margin: 0;
    border-bottom: 1px solid #eee;
                       ...
                       <div class="addsavvioncheck-section">
                            ...
                            <div class="addsavvioncheck-section-first">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="PassportNo" id="PassportNo" class="form-control" value="<?=$data['PassportNo']?>" placeholder="Passport No">
                                </div>
                                <div class="form-group">
                                    <label for="AKAName">AKAName:  </label>
                                    <input type="text" name="AKAName" id="AKAName" class="form-control" value="<?=$data['AKAName']?>" placeholder="AKAName">
                                </div>
                                <div class="form-group">
                                    <label for="Gender">Gender:  </label>
                                    <input type="text" name="Gender" id="Gender" class="form-control" value="<?=$data['Gender']?>" placeholder="Gender">
                                </div>
                                <div class="form-group">
                                    <label for="Nationality">Nationality:  </label>
                                    <input type="text" name="Nationality" id="Nationality" class="form-control" value="<?=$data['Nationality']?>" placeholder="Nationality">
                                </div>
                                <div class="form-group">
                                    <label for="ArabicName">Arabic Name:  </label>
                                    <input type="text" name="ArabicName" id="ArabicName" class="form-control" value="<?=$data['ArabicName']?>" placeholder="Arabic Name">
                                </div>
                            ...
                            <div class="addsavvioncheck-section-btn">
                                ...
                                <button type="submit" class=" btn btn-success dropdown-toggle" style="float: left;background: #bbed21;border-color: #bbed21;font-weight: bold;color: #535c69;text-transform: uppercase;font-size: 12px;line-height: 27px; display:<?php echo $buttonDisplay?>;" name="addsavvioncheck" > <span>
                                <?=isset($_REQUEST['check'])?'Edit':'Add'?>
                                Check</span> </button>
                      ...
                      <table class="table table-bordered table-striped">
						...
						elseif($LEVEL == 10 || $LEVEL == 3){
							...
							$checks = $db->select("dataflow","*","`status` = 1 AND is_active=1 AND team_lead_id='$uID'  ORDER BY id DESC");
								...
								$checks = $db->select("dataflow","*"," is_active=1 ORDER BY id DESC");
						}
...
function valueChanged()
{
    if($('.isErrorBox').is(":checked"))   
        $(".Is_Error_Comments").slideToggle(200);
    else
        $(".Is_Error_Comments").slideToggle(200);
}
