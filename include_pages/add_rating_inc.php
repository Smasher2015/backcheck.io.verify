...
if($_REQUEST['missystem'] == "yes")
{
	...
	$error_found = false;
		...
		$receivdate = ($_REQUEST['receivdate']=='' || $_REQUEST['receivdate']=='-')?date('Y-m-d'):$_REQUEST['receivdate'];
	...
	$countbcode = @mysql_num_rows($as_bcode);
			if($countbcode > 0)
			{
				...
				$mysql_fetch_array = @mysql_fetch_assoc($as_bcode);
					...
					$ianame =  ($mysql_fetch_array['checks_title']=='Education')?$mysql_fetch_array['ia_name']:$ianame;
