...
T: +65 31080343  |  F: +65 67228310<br />
            ...
            <a href="www.backcheckgroup.com">www.backcheckgroup.com</a>-->
				...
				<div class="cnt-bgc-txt-bt">Copyright BACKGROUND CHECK GROUP - ALL RIGHTS RESERVED</div>
				...
				<?php /*?><div class="headline">
                	...
                	<span style="margin-left:20px;">
                    	...
                    	<?php if($ascase==0) echo "$fnos-"; echo $asData['checks_title'];?>
                            ...
                            <tr><td colspan="2"><h3><?php if($ascase==0) echo "$fnos-"; echo $asData['checks_title'];?></h3>                
</td></tr>
                            <tr>
                                ...
                                <p style="font-weight:bold; color:#030;">
