...
function mainfunction(addoredit,id)
	...
	// alert(insid+" xxxx");
  	   $.ajax({
				...
				//console.log(response.checks_title);
				...
				<div class="col-lg-3">
                    ...
                    <option value="-">-- Filter by components --</option>		
					  ...
					  $checkss= array ();
						...
						?>
						 <option value="healthlicense">healthlicense</option>
                    </select>
				</div>
            ...
            <?php 
              ...
              ?>
               ...
               <tr>
					...
					<td>
                    <input id="receivdate" type="text" name="receivdate"  class="form-control" placeholder="Search by Start Date"  value="<?php echo date('d-M-Y');?>" onblur="mainfunction('add','')" style="width: 96px;" readonly>            
					</td>
                    <td>
                    ...
                    <select name="componenets" id="componenets" onchange="mainfunction('add','')" readonly="readonly" class="select">
			   ...
			   <td style="display:none;"><?=$inx?></td>
                ...
                <input type="checkbox" name="record_id[]" id="record_id_<?=$cc?>" class="cheks " value="<?=$re['misID']?>" /> <?php echo $fullName; ?> </td>
				   ...
				   echo $re['components'];
					...
					<td>
					<?php //echo $re['qualification_detail']?>
					<input type="text" name="qualification_detail_<?=$re['misID']?>" id="qualification_detail_<?=$re['misID']?>" placeholder="Qualification/ Component Detail" value="<?=$re['qualification_detail']?>" onblur="mainfunction('edit','<?=$re['misID']?>')" />
					</td>
