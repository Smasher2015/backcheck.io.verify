				...
				if($company_id){?>	
                      ...
                      <?php } ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="progress-bar-parent mainDivchecks"  >
                                            ...
                                            <?php }?>
                                            	...
                                            	<input style="float:right; display:none;" type="checkbox" name="ischeck1[]" data-parsley-required="true" data-parsley-error-message="You must select at least one check" class="parsley-validated parsley-error tickbox" value="<?=$check['checks_id']?>_1" checked="checked" id="<?=$num_check?>"  />
                                            </h4>
						   ...
						   ?>
                            ...
                            <input type="text" name="uni_name1_1" placeholder="University Name<?php echo $aesteric;?>" value="" class="form-control  <?php echo $parsley_validated_class; ?> typeahead-basic" <?php echo $parsley_validated_true; ?>  >
                            </div></div>
                            <div class="col-md-6">
                            <div class="form-group">
                            
                            <input type="text" name="reg_num1_1" placeholder="Registration Number<?php echo $aesteric;?>" value="" class="form-control  <?php echo $parsley_validated_class; ?>" <?php echo $parsley_validated_true; ?>  >
                            </div></div>
                            ...
                            <input type="text" name="degree1_1" placeholder="Degree Title<?php echo $aesteric;?>" value="" class="form-control <?php echo $parsley_validated_class; ?>" <?php echo $parsley_validated_true; ?>   title="Type Qualification e.g: BSC,MSC,BCS">
                            </div></div>
                            <div class="col-md-6">
                            <div class="form-group">
                            
                            <input type="text" name="remarks1_1" placeholder="Remarks<?php echo $aesteric;?>" value="" class="form-control <?php echo $parsley_validated_class; ?>" <?php echo $parsley_validated_true; ?>   title="Type Remarks e.g: Passed,Fail">
                            ...
                            <input type="text" name="pass_year1_1" placeholder="Passing Year<?php echo $aesteric;?>" value="" class="form-control <?php echo $parsley_validated_class; ?>" <?php echo $parsley_validated_true; ?>title="">
                            </div></div>
                            <div class="col-md-6">
                            <div class="form-group">
                             
                            <input type="text" name="serial_no1_1" placeholder="Serial No<?php echo $aesteric;?>" value="" class="form-control <?php echo $parsley_validated_class; ?>" <?php echo $parsley_validated_true; ?>   title="">
                            </div></div>
						   ...
						   ?>
                            ...
                            <input type="text" name="company_name1_1" placeholder="Company Name<?php //echo $aesteric;?>" value="" class="form-control  <?php //echo $parsley_validated_class; ?> typeahead-basic2 " <?php //echo $parsley_validated_true; ?> >
                            </div></div>
                            
                            <div class="col-md-6">
                            <div class="form-group">
                             
                            <input type="text" name="date_of_join1_1" id="date_of_join0" placeholder="Date of Joining (YYYY-MM-DD)<?php //echo $aesteric;?>" value="" class="form-control  date datetimepicker-month <?php //echo $parsley_validated_class; ?>" <?php //echo $parsley_validated_true; ?>   title="Type Date of Joining (YYYY-MM-DD)">
                            </div></div>
                            <!--]-->
                            ...
                            <input type="text" name="emp_status1_1" placeholder="Employement Status<?php //echo $aesteric;?>" value="" class=" form-control  <?php //echo $parsley_validated_class; ?>" <?php //echo $parsley_validated_true; ?>  >
                            </div></div>
                            <div class="col-md-6">
                            <div class="form-group">
                             
                            <input type="text" name="last_work_day1_1" placeholder="Last Working Day<?php //echo $aesteric;?>" value="" class=" form-control  <?php //echo $parsley_validated_class; ?>" <?php //echo $parsley_validated_true; ?>   >
                            </div></div>
                            
                            <div class="col-md-6">
                            <div class="form-group">
                             
                            <input type="text" name="last_designation1_1" placeholder="Last Designation<?php //echo $aesteric;?>" value="" class=" form-control  <?php //echo $parsley_validated_class; ?>" <?php //echo $parsley_validated_true; ?>   >
                            </div></div>
                            <div class="col-md-6">
                            <div class="form-group">
                             
                            <input type="text" name="last_place_posted1_1" placeholder="Last Place of Posting<?php //echo $aesteric;?>" value="" class=" form-control  <?php //echo $parsley_validated_class; ?>" <?php //echo $parsley_validated_true; ?>  >
                            </div></div>
