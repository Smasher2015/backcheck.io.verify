                             ...
                             <div class="addsavvioncheck-section2">
                                ...
                                <div class="crm-remarks">
                                    <div class="form-group">
                                        ...
                                        <textarea name="_UNBOUND_textArea3" class="form-control parsley-validated" rows="4" data-parsley-minwords="4" data-parsley-required="true" placeholder="CRM Remarks" <?if($uID != 261){echo "readonly";}?>><?=$data['_UNBOUND_textArea3']?> </textarea>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="HistoryRemarks">History Remarks: </label>
                                        <textarea name="HistoryRemarks" class="form-control parsley-validated" rows="4" data-parsley-minwords="4" data-parsley-required="true" placeholder="History Remarks" <?if($uID != 261){echo "readonly";}?>><?=$data['HistoryRemarks']?></textarea>
                                    </div>
...
function valueChanged()
{
    if($('.isErrorBox').is(":checked"))   
        $(".Is_Error_Comments").css("display","block");
    else
        $(".Is_Error_Comments").css("display","none");
}
...
$(function() {
	$('#VStatus').change(function(){
		...
		$('#Verified_Negative2 select').val('0');
		$('#Verified_Major_Negative2 select').val('0');
	});
});
