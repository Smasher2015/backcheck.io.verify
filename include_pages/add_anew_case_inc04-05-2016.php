                  ...
                  <div class="col-md-9">
                    ...
                    <div>
                            ...
                            <?php	
                             ...
                             <fieldset class="col-md-6">
                                            <div class="form-group ">
												...
												value="<?php echo $_REQUEST['ename1'];?>"  data-parsley-required="true" id="ename1" <?php echo $readOnly;?>>
                              ...
                              <fieldset class="col-md-6">
                                <div class="form-group ">
                                    <input type="text" name="fname1" class="form-control  parsley-validated" placeholder="Father Name" value="<?php echo $_REQUEST['fname1'];?>" data-parsley-required="true" id="fname1" <?php echo $readOnly1;?>>
                                    <span class="validate_fname"></span>
                                        ...
                                        <fieldset class="col-md-6">
                                            <div class="form-group">
												...
												onkeyup="this.value=this.value.replace(/[^\d]/,'');" maxlength="50" <?php echo $readOnly2;?>>
											...
											<fieldset class="col-md-6">
                                            <div class="form-group ">
                                                <input type="text" name="dob1" class="form-control <?php echo ($readOnly3=='')?'datetimepicker-month1':'';?>" placeholder="Date of Birth" value="<?php echo $_REQUEST['dob1'];?>" <?php echo $readOnly3;?> readonly>
										...
										<fieldset class="col-md-6">
                                            <div class="form-group ">
                                                <input type="text" name="empcode1" class="form-control parsley-validated emp_id" placeholder="<?php echo CLIENT_REF_NUM;?>" title="<?php echo CLIENT_REF_NUM;?>" value="<?php echo $_REQUEST['empcode1'];?>"  <?php echo $checkEmpcode_onclick;?> data-parsley-required="true" maxlength="20" <?php //echo $readOnly4;?>>
                      ...
                      <?php } ?>
                                  ...
                                  <fieldset class="col-md-6">
                                            <div class="form-group ">
                                                <input type="text" name="v_address1" class="form-control  parsley-validated" placeholder="Address" value="<?php if(trim($_REQUEST['v_address'])){echo $_REQUEST['v_address'];}?>">
                    ...
                    <?php
                          ...
                          <?php
						   ...
						   ?>
                            ...
                            <input type="text" class="form-control typeahead-basic" name="uni_name1_1" placeholder="University Name"  >
                           ...
                           <?php /*?> <select name="uni_name1_1" id="unidropdowns" class="select clss_hide_remov1" onchange="selectinguni();" >
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="reg_num1_1" placeholder="Registration Number" value="" class="form-control clss_hide_remov1"  >
                            </div></div>
                            
                            
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="degree1_1" placeholder="Degree Title" value="" class="form-control clss_hide_remov1"  title="Type Qualification e.g: BSC,MSC,BCS">
                            </div></div>
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="remarks1_1" placeholder="Remarks" value="" class="form-control clss_hide_remov1"   title="Type Remarks e.g: Passed,Fail">
                            
                            </div></div>
                            
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="pass_year1_1" placeholder="Passing Year" value="" class="form-control clss_hide_remov1" title="">
                            </div></div>
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="serial_no1_1" placeholder="Serial No" value="" class="form-control clss_hide_remov1"  title="">
                            </div></div>
...
<?php */?>                          
						   ...
						   ?>
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="company_name1_1" placeholder="Company Name" value="" class="form-control clss_hide_remov1 typeahead-basic2">
                            </div></div>
                            
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="date_of_join1_1" id="date_of_join0" placeholder="Date of Joining (YYYY-MM-DD)" value="" class="form-control clss_hide_remov1 date datetimepicker-month"   title="Type Date of Joining (YYYY-MM-DD)">
                            </div></div>
                            <!--]-->
                            
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="emp_status1_1" placeholder="Employement Status" value="" class="form-control clss_hide_remov1" >
                            </div></div>
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="last_work_day1_1" placeholder="Last Working Day" value="" class="form-control clss_hide_remov1" >
                            </div></div>
                            
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="last_designation1_1" placeholder="Last Designation" value="" class="form-control clss_hide_remov1" >
                            </div></div>
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="last_place_posted1_1" placeholder="Last Place of Posting" value="" class="form-control clss_hide_remov1" >
                            </div></div>
                            
                            <div class="col-md-4">
                            <div class="form-group">
                            <input type="text" name="last_drawn_salary1_1" placeholder="Last Drawn Salary" value="" class="form-control clss_hide_remov1 " >
                            </div></div>
	 ...
	 $('.mainDivchecks').each(function (ind,obj){
		 ...
		 if(vl[0] == 1)
		 {
			if($(this).find('.checkAttached').html()==""){
				alert("Please add attachment for education !");
								valid = false;
							   return valid;
			}
		 }
