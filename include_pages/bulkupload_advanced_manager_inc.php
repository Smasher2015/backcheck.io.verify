							...
							$where = "cc.com_id=$company_id AND ck.is_active=1 AND cc.clt_active=1";
								...
								<div class="checkbox bulk_check col-md-4">
											<label>
												...
												Amount: <?php echo getCheckAmount($company_id,$check['checks_id']);?>
												</span></a>
                                            <?php }?>
											</label>
								</div>
		...
		$len = strlen($_FILES["bulk_file"]["name"]);
			...
			$values='';
                ...
                <div class="section-sprate">
                            ...
                            <p class="text-muted float-right"  > <a class="ctooltips" href="#" ><i class="icon-info22"></i><span>Allowed file types:<br />
