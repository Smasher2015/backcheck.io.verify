    ...
    <div class="report-sec">
      <div class="panel panel-default panel-block">
        ...
        <div class="bulk-dev" id="demo">
		  ...
		  <input type="hidden" name="nadrabulk" value="1" />
                ...
                <div class="list-group">
                  <div class="list-group-item" id="input-fields-horizontal">
                    <div class="case_data">
                      ...
                      <div class="clearFix"></div>
                      <?php 
								$where = "cc.com_id=$company_id AND ck.is_active=1 AND cc.clt_active=1 AND ck.checks_id=9";
                      ...
                      <div class="progress-bar-parent">
                        <h4 class="section-title">
                          ...
                          <?php }?>
                          <input style="float:right;" type="checkbox" name="ischeck<?=($lCount-1)?>[]" value="<?=$check['checks_id']?>_1"   data-parsley-required="true" data-parsley-error-message="You must select at least one check" class="parsley-validated parsley-error tickbox" id="<?=($lCount-1)?><?=$num_check?>" checked="checked"/>
                        </h4>
                        <div>
                          <div>
                            ...
                            <input type="file" name="files[]" id="docs<?=($lCount-1)?><?=$num_check?><?=$check['checks_id']?>" multiple="multiple" class="docs_files" data-id="<?=$num_check?>" data-check="<?=$check['checks_id']?>" data-count="<?=($lCount-1)?>" data-ccounter="_1" data-attchid="<?=$num_check?>" onclick="uploadAttach('docs<?=($lCount-1)?><?=$num_check?><?=$check['checks_id']?>')"/>
                            </span>
    ...
    right: 155px;" name="submit_bulk">Submit Checks</button>
			...
			fclose($fp);			
              ...
              <div class="list-group-item">
                <button type="button" class="btn btn-success" onclick="document.location='files/format/applicant-bulkupload-sample.csv'"    ><i class="icon-file-text-alt"></i> Download Sample Format</button>
                <br />
                <div class="form-group">
