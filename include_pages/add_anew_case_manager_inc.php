	 ...
	 if($_REQUEST['ERR']==""){
	if((!isset($_REQUEST['is_sub_pkg_drop']))){
	$_REQUEST['ename1']="";
	$_REQUEST['fname1']="";
	$_REQUEST['cnic1']="";
	$_REQUEST['dob1']="";
...
if(is_numeric($_REQUEST['case']) && $_REQUEST['case']!=0){ 
	...
	$_REQUEST['country'] = $ver_data['v_country'];
	$_REQUEST['v_uadd'] = $ver_data['v_uadd'];
	$_REQUEST['v_image'] = $ver_data['image'];
	$_REQUEST['v_address1'] = $ver_data['v_address'];
...
<form enctype="multipart/form-data" method="post" id="addCheckFrm" name="addCheckFrm"  data-parsley-namespace="data-parsley-" data-parsley-validate="" >
                ...
                <div class="row">
                  ...
                  <div class="col-md-9">
                    ...
                    <div>
                              ...
                              <fieldset class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <span class="validate_fname"></span>
                                      ...
                                      <fieldset class="col-md-6">
                                            <div class="form-group ">
                                                <input type="text" name="v_address1" class="form-control  parsley-validated" placeholder="Current Resident Address" value="<?php if(trim($_REQUEST['v_address1'])){echo $_REQUEST['v_address1'];}?>" title="Current Resident Address">
                      ...
                      <option value="<?=$country['country_id']?>" <?=($_REQUEST['country']==$country['country_id'])?'selected="selected"':($country['country_id']==171)?'selected="selected"':''?> >
                    ...
                    <?php
                          ...
                          <?php
						   ...
						   ?>
                            ...
                            <input type="text" class="form-control typeahead-basic <?php echo $parsley_validated_class; ?>" <?php echo $parsley_validated_true; ?> name="uni_name1_1" placeholder="University Name<?php echo $aesteric;?>"   >
...
<script type="text/javascript">
$("#ord_typ").on('change',function(){
	var vl = $(this).val();
	//alert("vl: "+vl);
	if(confirm("Are you sure want to change order type?")){
		
	 
	
	$("#is_sub_pkg_drop").val(1);
	
	document.addCheckFrm.submit();
	}    
});
$(document).ready(function(){

// Functionality for custom or pakcage order Start //



// Functionality for custom or pakcage order End //
