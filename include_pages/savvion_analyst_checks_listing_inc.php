                 ...
                 <div>
					...
					<form class="table-form" action="" method="post">
                         <div class="form-group">
                                    <label>Checks Status :</label>
                                    <select class="form-control" id="source" name="status">
                                    	<option value="">Please Select</option>
                                        <option value="1">New</option>
                                    	<option value="2">Sent To QC</option>
                                        <option value="3">QC Approved</option>
                                        <option value="5">Insufficient</option>

                                    </select>
                                </div>
                     		 <button type="submit" class=" btn btn-success dropdown-toggle" style="float:right;" name="SavvionChecksFilter" > <span>Filter</span> </button>
                      </form>
                      <table class="table table-bordered table-striped" id="tableSortable">
                        ...
                        <tbody>
						 ...
						 if($LEVEL == 10 ){
							 ...
							 $analyst = 'user_id = '.$uID . $status;
						}else{
							$analyst = '';
							}
						$checks = $db->select("savvion_check","*",$analyst);
